  ...
  type
    ...
    public
     ...
     constructor Create(const aNome: String; const aEnd: String;
                   const aIdade: Integer; const aCPF: String );
...
constructor TpessoaFisica.Create(const aNome: String; const aEnd:
     String; const aIdade: Integer; const aCPF: String);
begin
  Fnome     := aNome;
  FEndereco := aEnd;
  FIdade    := aIdade;
...
function TpessoaFisica.isCPF: boolean;
