...
begin
  case TNivel(rdoNivel.ItemIndex) of
    tpEstagiario:
    begin
      Xfrase := ' Eu ' +edtNome.text + ', Seu nivel é Estagiario você chega lá!';
    end;
      tpJunior:
    begin
      Xfrase := ' Eu ' +edtNome.text + ', Seu nivel é Junior, você está melhorando!.';
    end;
      tpPleno:
    begin
      Xfrase := ' Eu ' +edtNome.text + ', Seu nivel é Pleno, falta pouco!!!!';
    end;
      tpSenior:
    begin
      Xfrase := ' Eu ' +edtNome.text + ', Seu nivel é Senior, parabens voce conseguiu!';
    end ;
  end ;
  showMessage(xfrase);
end;
...
begin
  if edtNome.Text = 'michael' then
    ...
    showMessage('Você não e o michael')
