...
begin
  ...
  lbResultado.caption := 'Total A pagar :' +FloatToStr(xTotalPagar)+#10#13+ ' Total Desconto :' +FloatToStr(xTotalDesconto);
...
veículos com desconto. Faça um algoritmo que calcule e exiba o
...
combustível (álcool – 25%, gasolina – 21% ou diesel –14%).
Com valor do veículo zero encerra entrada de dados. Informe
