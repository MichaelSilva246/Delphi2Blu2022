...
begin
  ...
  begin
    ...
    xPrecoCusto := StrToFloat(inputbox('Preco Custo', 'Digite o Preço de custo', ''));
    xPrecoVenda := StrToFloat(inputbox('Preco Venda', 'Digite o Preço de Venda', ''));
...
de 40 produtos. Mostre como resultado se houve lucro, prejuízo ou
empate para cada produto.

Informe o valor de custo de cada produto,o valor de venda de
cada produto, a média de preço de custo e do preço de venda;
