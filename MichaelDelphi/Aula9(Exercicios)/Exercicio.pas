...
begin
  ...
  lbResultado.Caption := (' A Soma é: ' +FloatToStr(xSoma)+#10#13+
                      ' A Subtração é: '+FloatToStr(xSubtrai)+#10#13+
                      ' A Multiplicacao é: '+FloatToStr(xMultiplica)+#10#13+
                      ' A Divisão é: '+FloatToStr(+xDivide));
end;
