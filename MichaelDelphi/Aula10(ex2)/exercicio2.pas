...
begin
  ...
  if xMedia >= 7 then
    tmMedia.lines.add(' Parabéns ' +edtNome.text+ ' Aprovado com media superior a 7, sua media foi de: ' +FloatToStr(xMedia))
  else
    tmMedia.lines.add(' Recuperação ' +edtNome.text+ ' Recuperacao com media inferior  a 7, sua media foi de: ' +FloatToStr(xMedia))
